...
contract DeployIncentivesDumper is Script {
    ...
    function run() public {
        vm.startBroadcast();
        IncentivesDumper dumper = new IncentivesDumper(bgtIncentiveDistributor, obAggregator);
        console2.log("DeployIncentivesDumper | IncentivesDumper deployed at:", address(dumper));
        vm.stopBroadcast();
    }
    ...
    function dump() public {
        ...
        IIncentivesDumper.UserInfo[] memory userInfos = new IIncentivesDumper.UserInfo[](1);
        userInfos[0] = IIncentivesDumper.UserInfo({
            user: 0x7E8D41FFDbfB8Bdb5D3D4F74a9FC872496f9246e,
            amountIn: 5294435604730205903
        });

        bytes memory pathDefinition = hex'';
        ...
        swapInfos[0] = IIncentivesDumper.SwapInfo({
            ...
            routerParams: IIncentivesDumper.RouterParams({
        ...
        IncentivesDumper(payable(0xc6e7DF5E7b4f2A278906862b61205850344D4e7d)).dumpIncentives(3, claims, swapInfos);
        vm.stopBroadcast();
    }
}
